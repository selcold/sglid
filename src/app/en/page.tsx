          ...
          {isSiteViewLoad ? (
            <>
              ...
              <div className="undefined w-full">
                <div className="mx-auto w-full max-w-[1240px] px-6 lg:px-10 py-6 lg:py-10 text-center py-16 lg:!pt-20 lg:!pb-16 relative z-1">
                  ...
                  <div className='flex flex-wrap items-center justify-center mt-3 lg:mt-6 gap-5'>
            ...
            <div className='fixed flex flex-col justify-center items-center w-full h-full'>
              ...
              <div className='gap-4 flex flex-col justify-center items-center'>
                <input type='text' placeholder='password' className='flex min-h-[20px] min-w-[200px] lg:w-[400px] rounded-md border border-zinc-700 border-input bg-zinc-900 px-3 py-2 mt-[10px] text-sm ring-offset-background focus-visible:outline-none' onChange={(e) => setViewLocked_password(e.target.value)}/>
